...
(function () {
    ...
    const translations = {
        en: {
            ...
            'p2.highlight': 'Now accepting entries! Deadline: Sunday, November 15. Bring your AI film to the big screen',
            ...
            'sp.item_award': '<strong>Naming rights for an award at one on-site event (the hackathon or the film festival) (e.g., the ○○ Award, the ○○ CEO Award — presented with any name and comment you like)</strong>',
            ...
            'sp.item_opening': 'Company name & logo introduced during the event',
        ...
        zh: {
            ...
            'p2.highlight': '作品征集中！截止日期为11月15日（周日）。让你的AI影像登上大银幕',
            'p3.title': 'AI展示体验会',
            ...
            'sp.item_award': '<strong>可在任一现场活动（黑客马拉松或电影节）中冠名奖项（例：〇〇奖、〇〇总裁奖等，名称与颁奖评语均可自定）</strong>',
            ...
            'sp.item_opening': '活动中介绍企业名称与Logo',
        ...
        fr: {
            ...
            'p2.highlight': 'Candidatures ouvertes ! Date limite : dimanche 15 novembre. Portez votre film IA sur grand écran',
            ...
            'sp.item_award': '<strong>Droit de nommer un prix lors de l’un des événements sur place (hackathon ou festival du film) (ex. : Prix ○○, Prix du PDG de ○○ — remis avec le nom et le commentaire de votre choix)</strong>',
            ...
            'sp.item_opening': 'Nom et logo de l’entreprise présentés pendant l’événement',
        ...
        de: {
            ...
            'p2.highlight': 'Einreichungen jetzt möglich! Frist: Sonntag, 15. November. Bring deinen KI-Film auf die große Leinwand',
            ...
            'sp.item_award': '<strong>Namensrecht für einen Preis bei einer der Veranstaltungen vor Ort (Hackathon oder Filmfestival) (z. B. ○○-Preis, ○○-CEO-Preis — verliehen mit Namen und Laudatio Ihrer Wahl)</strong>',
            ...
            'sp.item_opening': 'Vorstellung von Firmenname & Logo während der Veranstaltung',
